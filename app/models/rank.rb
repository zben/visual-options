class Rank < ActiveRecord::Base
  ...
  def self.download_data
    ...
    require 'open-uri'
    day = Date.today
    if !day.saturday? and !day.sunday? and today_is_trading_day?
      ActiveRecord::Base.transaction do
         ...
         #"Ticker","Company","Industry","Market Cap","20-Day Simple Moving Average","50-Day Simple Moving Average","200-Day Simple Moving Average","Price","Change","Volume"
           ...
           rank = Rank.create(:stock_id=>stock.id,:close_price=>line['Price'],:volume=>line['Volume'],:sma20=>line['20-Day Simple Moving Average'],:sma50=>line['50-Day Simple Moving Average'],:sma200=>line['200-Day Simple Moving Average'],:date=>day,:percent_change=>line['Change'])
  #         puts rank.id
